...
from official_page_data_collector import OfficialPageDataCollector
...
class BymExhibitionPageCreater(object):
    def __init__(self,
        ...
        self.official_data_collector = OfficialPageDataCollector(chnl_url, prod_code_list)

        self.bym_extract_data = self.bym_data_collector.data_dict
        self.lv_extract_data = self.official_data_collector.data_dict
    ...
    def _write_memo(self):
        message = datetime.date.today().strftime('%Y/%m/%d') + " タナベ" + "/" + self.exhbit_no
